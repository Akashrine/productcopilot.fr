...
Le `design.md` est le fichier qui fait la différence entre un prototype AI slop et un produit avec une identité.

Tu veux le système complet pour passer de l'idée au produit ? 12 prompts chaînés, du PRD au design au code à l'audit.

[Découvre le Pack Vibe Coding for PMs →](/packs/vibe-coding-pm)
